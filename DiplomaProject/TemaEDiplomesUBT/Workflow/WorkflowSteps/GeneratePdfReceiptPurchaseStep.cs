...
namespace TemaEDiplomesUBT.Workflow.WorkflowSteps
{
    ...
    public class GeneratePdfReceiptPurchaseStep : StepBody
    {
        ...
        public override ExecutionResult Run(IStepExecutionContext context)
        {
            try
            {
                string baseFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "ReceiptsForPurchase");
                ...
                using (var document = new PdfDocument())
                {
                    ...
                    yPoint += 30;
                    gfx.DrawString($"Supplier: {SupplierName}", headerFont, XBrushes.Black, new XRect(margin, yPoint, page.Width - margin * 2, page.Height), XStringFormats.TopLeft);
                    yPoint += 20;
                    ...
                    foreach (var detail in PurchaseDetails)
                    {
                        ...
                        decimal subtotal = detail.Quantity * detail.PurchasePrice;
                        ...
                        gfx.DrawString(detail.PurchasePrice.ToString("C2"), font, XBrushes.Black, new XRect(margin + 400, yPoint, 100, page.Height), XStringFormats.TopLeft);
